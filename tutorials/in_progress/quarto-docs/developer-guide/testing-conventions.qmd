...
from pyapprox.util.test_utils import load_tests  # Shared loader
...
Always import `load_tests` from `pyapprox.util.test_utils` rather than defining it in each test file. This ensures consistent behavior across all tests.
:::
...
from pyapprox.util.backends.torch import TorchBkd
from pyapprox.util.backends.protocols import Array
from pyapprox.surrogates.kernels.my_kernel import MyKernel
from pyapprox.util.test_utils import load_tests  # Shared loader
...
python -m unittest pyapprox.surrogates.kernels.tests.test_my_kernel

# Run specific test class (both backends)
python -m unittest pyapprox.surrogates.kernels.tests.test_my_kernel.TestMyKernelNumpy
...
from pyapprox.util.backends.torch import TorchBkd
from pyapprox.util.backends.protocols import Array
from pyapprox.[module.path] import [ClassName]
from pyapprox.util.test_utils import load_tests  # Import shared loader
...
2. Import `load_tests` from `pyapprox.util.test_utils`
