...
class TestFenicsUtilities(unittest.TestCase):
    def test_onstrained_newton_energy_solver(self):
        ...
        parameters={"symmetric": True, "newton_solver": {
            "relative_tolerance": 1e-12, "report": True, \
            "linear_solver": "cg", "preconditioner": "petsc_amg"}}
        dl.solve(grad==0, u_grad, dirichlet_bcs, solver_parameters=parameters)
    ...
    def test_mark_boundaries(self):
        ...
        boundary_conditions = \
            get_dirichlet_boundary_conditions_from_expression(bc_expr1,0,1,0,1)
    ...
    def test_save_fenics_function(self):
        ...
        raise Exception('does not work if calling load function again')
