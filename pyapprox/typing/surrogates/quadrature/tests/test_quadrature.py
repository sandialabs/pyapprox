...
class TestStroudCubature(unittest.TestCase):
    ...
    def test_cd2_nsamples(self):
        ...
        from pyapprox.typing.surrogates.quadrature import StroudCdD2
    ...
    def test_cd3_nsamples(self):
        ...
        from pyapprox.typing.surrogates.quadrature import StroudCdD3
    ...
    def test_cd5_nsamples(self):
        ...
        from pyapprox.typing.surrogates.quadrature import StroudCdD5
