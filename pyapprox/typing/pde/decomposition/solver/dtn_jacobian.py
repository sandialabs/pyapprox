...
from pyapprox.typing.pde.decomposition.protocols.interface import InterfaceProtocol
from pyapprox.typing.pde.decomposition.subdomain.wrapper import SubdomainWrapper
from pyapprox.typing.pde.decomposition.solver.dtn_residual import DtNResidual
