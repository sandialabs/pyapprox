...
class ExampleParameterizedFunctionWithHVP(FunctionOfParametersWithHVP[Array]):
    """
    ...
    def set_parameter(self, p: Array) -> None:
        ...
        Set the parameter p.
        """
        validate_sample(self.nparams(), p)
        self._param = p
...
class TestParameterizedFunction(Generic[Array], AbstractTestCase):
    ...
    def test_function_of_parameters_with_jacobian(self) -> None:
        """
        ...
        func_of_params_with_jacobian = FunctionOfParametersWithHVP(
    ...
    def test_function_of_parameters_with_hvp(self) -> None:
        """
