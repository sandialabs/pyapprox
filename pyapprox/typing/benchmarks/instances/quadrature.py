"""Fixed quadrature benchmark instances.

These are pre-configured benchmark instances for testing integration
algorithms with known analytical integrals.
"""

from pyapprox.typing.util.backends.protocols import Array, Backend
from pyapprox.typing.benchmarks.benchmark import Benchmark, BoxDomain
from pyapprox.typing.benchmarks.ground_truth import QuadratureGroundTruth
