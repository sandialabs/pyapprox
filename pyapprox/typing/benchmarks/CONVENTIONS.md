...
This document defines the conventions for creating and using benchmarks in `pyapprox.typing.benchmarks`.
...
Benchmarks differ from the reusable function implementations in `pyapprox.typing.interface.functions` - they are pre-configured instances with specific parameters and domain bounds.
...
from pyapprox.typing.benchmarks.registry import BenchmarkRegistry
from pyapprox.typing.benchmarks.functions.algebraic.my_function import MyFunction
