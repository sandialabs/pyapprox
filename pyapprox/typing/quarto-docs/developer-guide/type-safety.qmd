...
Every function, method, and class in `pyapprox.typing` must have complete type annotations.
:::
...
from pyapprox.typing.util.backends.protocols import Array, Backend
from pyapprox.typing.surrogates.kernels.protocols import KernelWithJacobianProtocol
