...
```{python}
#| fig-cap: "Smolyak merging for a 2D, level-2 sparse grid with f(x1, x2) = x1^2 + x1*x2. Each panel shows one tensor product subspace with its Smolyak coefficient and PCE multi-indices. The final merged PCE (bottom right) accumulates overlapping coefficients."
