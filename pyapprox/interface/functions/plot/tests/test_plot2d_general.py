...
class TestPlotter2DGeneralDomainNumpy(TestPlotter2DGeneralDomain[NDArray[Any]]):
    def setUp(self) -> None:
        self._bkd = NumpyBkd()
        super().setUp()
...
class TestPlotter2DGeneralDomainTorch(TestPlotter2DGeneralDomain[torch.Tensor]):
    def setUp(self) -> None:
        self._bkd = TorchBkd()
        super().setUp()
