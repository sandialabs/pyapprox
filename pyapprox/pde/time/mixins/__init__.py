...
SensitivityMixin          -- is_explicit, has_prev_state_hessian, sensitivity_off_diag_jacobian
QuadratureMixin           -- _get_quadrature_class, quadrature_samples_weights
AdjointMixin              -- adjoint methods, param_jacobian
HVPMixin                  -- state_state_hvp, state_param_hvp, param_state_hvp, param_param_hvp
PrevStepHVPMixin          -- prev_state_state_hvp, prev_state_param_hvp, prev_param_state_hvp
"""
