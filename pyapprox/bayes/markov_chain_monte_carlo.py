...
# def _marginalize_unnormalized_pdf(
#         variable, unnormalized_pdf, sub_indices, sub_samples, quad_degrees):
#     from pyapprox.surrogates.polychaos.gpc import _marginalize_function_nd
#     from functools import partial
#     return _marginalize_function_nd(
#         partial(unnormalized_pdf, sub_indices),
#         variable, quad_degrees, sub_indices, sub_samples)
