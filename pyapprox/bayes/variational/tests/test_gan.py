...
class TestGAN:
    ...
    def test_conditional_gan(self):
        ...
        nobs = 2
        obs_mat = bkd.asarray(np.random.uniform(0, 0.5, (nobs, nvars)) + 1e-2)
        ...
        nqoi = 1
        pred_mat = bkd.asarray(np.random.uniform(0, 0.5, (nqoi, nvars)) + 1e-2)
        ...
        print(prior_pushforward.covariance(), "C")
