 ...
 */
        ...
        __pyx_t_24 = (__pyx_v_lb + __pyx_v_nn);
        __pyx_t_25 = __pyx_v_ii;
        __pyx_t_26 = __pyx_v_jj;
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_core_values_view.data + __pyx_t_25 * __pyx_v_core_values_view.strides[0]) ) + __pyx_t_26 * __pyx_v_core_values_view.strides[1]) )) += ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_basis_matrix.data + __pyx_t_22 * __pyx_v_basis_matrix.strides[0]) ) + __pyx_t_23 * __pyx_v_basis_matrix.strides[1]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_core_params.data + __pyx_t_24 * __pyx_v_core_params.strides[0]) ))));
      }
    }
  }
