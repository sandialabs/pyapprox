 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_coeffs_view.data + __pyx_t_18 * __pyx_v_coeffs_view.strides[0]) )) = ((*((double *) ( /* dim=0 */ (__pyx_v_coeffsI.data + __pyx_t_20 * __pyx_v_coeffsI.strides[0]) ))) * (*((double *) ( /* dim=0 */ (__pyx_v_coeffsII.data + __pyx_t_19 * __pyx_v_coeffsII.strides[0]) ))));
