 ...
 */
      ...
      __pyx_t_25 = (__pyx_v_jj - 2);
      __pyx_t_26 = __pyx_v_ii;
      __pyx_t_27 = __pyx_v_jj;
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_view.data + __pyx_t_26 * __pyx_v_p_view.strides[0]) ) + __pyx_t_27 * __pyx_v_p_view.strides[1]) )) = ((1.0 / (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ab.data + __pyx_t_18 * __pyx_v_ab.strides[0]) ) + __pyx_t_17 * __pyx_v_ab.strides[1]) )))) * ((((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_16 * __pyx_v_x.strides[0]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ab.data + __pyx_t_15 * __pyx_v_ab.strides[0]) ) + __pyx_t_14 * __pyx_v_ab.strides[1]) )))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_view.data + __pyx_t_7 * __pyx_v_p_view.strides[0]) ) + __pyx_t_8 * __pyx_v_p_view.strides[1]) )))) - ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ab.data + __pyx_t_20 * __pyx_v_ab.strides[0]) ) + __pyx_t_19 * __pyx_v_ab.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_view.data + __pyx_t_24 * __pyx_v_p_view.strides[0]) ) + __pyx_t_25 * __pyx_v_p_view.strides[1]) ))))));
    }
  }
...
if (unlikely(__pyx_memoryview_copy_contents(__pyx_v_p, __pyx_t_6, 2, 2, 0) < 0)) __PYX_ERR(0, 130, __pyx_L1_error)
    __PYX_XDEC_MEMVIEW(&__pyx_t_6, 1);
    __pyx_t_6.memview = NULL;
    __pyx_t_6.data = NULL;
  }
 ...
 */
    ...
    __pyx_t_14 = (((*((double *) ( /* dim=0 */ (__pyx_v_vals_view.data + __pyx_t_10 * __pyx_v_vals_view.strides[0]) ))) > 1.0) != 0);
    if (__pyx_t_14) {
    } else {
    ...
    __pyx_t_14 = ((((*((double *) ( /* dim=0 */ (__pyx_v_vals_view.data + __pyx_t_10 * __pyx_v_vals_view.strides[0]) ))) - 1.0) < __pyx_v_tol) != 0);
    __pyx_t_13 = __pyx_t_14;
 ...
 */
      ...
      *((double *) ( /* dim=0 */ (__pyx_v_vals_view.data + __pyx_t_10 * __pyx_v_vals_view.strides[0]) )) = 1.;
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction_0_29_35(__pyx_t_1, "gammaln", (void (**)(void))&__pyx_f_5scipy_7special_14cython_special_gammaln, "double (double, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
