...
benchmark = TunableModelEnsemble(theta1=np.pi/2*.95, shifts=[.1, .2])
model_ensemble = interface.ModelEnsemble(benchmark.models())
...
best_models = [benchmark.models()[idx] for idx in est._best_model_indices]
values_per_model = [
