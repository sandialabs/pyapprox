...
# TODO: these benchmarks do not use ground truth pattern. Do we
# need a multi-fidelity statistics ground truth, requiring
# high-fidelity stats with optional low-fidelity stats, and
# optional pilot stats, like covariance
