"""Transient adjoint gradient validation for the galerkin pipeline.

DerivativeChecker-validated dQ/dp for Q = y_k(T) through
adapter -> stepper -> BC-enforcing adjoint wrapper -> TimeIntegrator,
...
coupling that BE's identity-free rows cannot).
"""
