...
class TestConjugateGradient:
    ...
    def _create_spd_matrix(self, bkd, n: int):
    ...
    def test_larger_system(self):
        ...
        bkd = NumpyBkd()
        n = 10
        A = self._create_spd_matrix(bkd, n)
        x_true = bkd.ones((n,))
        b = A @ x_true
...
class TestPreconditionedCG:
    ...
    def _create_diag_dominant_spd(self, bkd, n: int):
    ...
    def test_pcg_with_jacobi(self):
        ...
        bkd = NumpyBkd()
        n = 10
        A = self._create_diag_dominant_spd(bkd, n)
        x_true = bkd.ones((n,))
        b = A @ x_true
