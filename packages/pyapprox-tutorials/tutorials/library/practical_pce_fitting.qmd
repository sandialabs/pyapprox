...
model = benchmark.problem().function()
...
from pyapprox_tutorials.figures._pce import plot_truncation_error
...
from pyapprox_tutorials.figures._pce import plot_train_test_cv
...
from pyapprox_tutorials.figures._pce import plot_train_test_cv_2panel
...
1. Run the truncation error experiment (see @fig-truncation-error) with degree 10. How many training samples are needed before the error curve flattens?
