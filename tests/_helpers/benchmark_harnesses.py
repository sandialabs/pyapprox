...
# TODO: Consider migrating verification strategies (MCMeanEstimator,
# MCVarianceEstimator) and harness functions to benchmarks/ as part of
# the benchmark framework's public API for comparing algorithms.
