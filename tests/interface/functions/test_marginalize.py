...
class TestFunctionMarginalizer:
    def test_marginalize_3d_to_2d(self, bkd) -> None:
        ...
        assert marg_2d.nvars() == 2
        assert marg_2d.nqoi() == 1
    ...
    def test_marginalize_3d_to_1d(self, bkd) -> None:
        ...
        assert marg_1d.nvars() == 1
        assert marg_1d.nqoi() == 1
    ...
    def test_marginalize_non_contiguous_indices(self, bkd) -> None:
    ...
    def test_marginalize_multi_qoi(self, bkd) -> None:
    ...
    def test_keep_all_variables(self, bkd) -> None:
    ...
    def test_non_unit_domain(self, bkd) -> None:
...
class TestCrossSectionReducer:
    def test_cross_section_3d_to_1d(self, bkd) -> None:
        ...
        assert reduced.nvars() == 1
        assert reduced.nqoi() == 1
    ...
    def test_cross_section_3d_to_2d(self, bkd) -> None:
    ...
    def test_cross_section_non_contiguous(self, bkd) -> None:
    ...
    def test_cross_section_keep_all(self, bkd) -> None:
    ...
    def test_cross_section_multi_qoi(self, bkd) -> None:
